...
std::vector<int> ClosedType::Production_Points() {
	return params.production_points;
}

std::vector<int> ClosedType::Consumption_Points() {
	return params.consumption_points;
}

Matrix ClosedType::New_Table() {
	return params.table;
}